...
const OUT=path.join(__dirname,'out7');fs.mkdirSync(OUT,{recursive:true});
...
This is not a scene. Draw only the figures or objects the moment is actually about, cut out and floating in generous empty white space, the way a sticker sits alone on a page. Plain white background. No setting, no environment, no scenery, no ground, no background elements or props. Include every element the moment needs to make sense and nothing more. Keep it simple, uncluttered, and readable at a glance.
