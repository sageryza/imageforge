...
family (coincidence, synchronicity, premonition) plus MEANING-mode passes for
the shape of the story rather than the word ("a strange thing happened to me
that could not have been chance"). No model call, nothing paid: the index and
its embeddings were already built.

**The rule the cards follow: her words, verbatim.** Every card's `text` is her
own telling, trimmed for length and never reworded — the house *nothing stands
between the source and the output* rule. Where a line of hers frames the story
better than any summary, it is the card's `caption` ("In your words"). Nothing
on a card is a chat's interpretation of what a coincidence meant.

**The deck.** Posted as a stock `deck` template into the
`suspicious-coincidences` chat's Compare tab — 37 cards, swipe or compare view,
♥/✕/maybe with voice notes, and a **Listen to the memo** link per card
(`/api/search/audio/<id>`) so a card plays the recording it was lifted from.

**Her own list, for cross-reference.** The memo `2026-08-02_1243` ("Nighttime
Creative Concepts") is where she names the ones she means to tell: the white
glove story, how she ended up with a witchcraft business, the thing with the
meteorite, lamenting she wasn't in any performance art pieces, the picture in
her journal and then what actually happened, and the Evan story split in two.
Every one of those is in the deck except *the picture in my journal* — that one
lives in a physical journal (`2026-06-03`: "that journal has the stuff about my
performance art piece and it has all the Book of Miracles stuff and I don't
think I took a picture of it"), so there is no recording to lift it from. **It
is the one gap, and it needs her, not another sweep.**

**Her own words for the mechanism**, which is why these hang together as one
set rather than a list of oddities:

- **instrumentalism** — "You follow your heart's desire and it leads you on a
  path that you didn't know existed." (`2026-05-28_1354`)
- **the theta state** — the minutes between waking and sleeping, where she
  pictures a thing and finds it the next day. (`2026-07-09_1048`)
- **a star** — "the name I have given to magical activities that have already
  taken place. Spells I have already cast, whose results I already saw."
  (`2026-08-11_0836`)
...
**The Evan phone call** — Jul 9, 2026  
...
> I don't like seeing the future. It's kind of hard, you know.

`memo 2026-07-09_0456_2026-07-09T11_56_09Z`

**Don't tell Evan** — Aug 2, 2026  
...
> Okay, well, I guess I shouldn't have told Evan. He and I haven't talked in two months.

`memo 2026-08-02_1243_2026-08-02T19_43Z`


### PICTURED IT, THEN FOUND IT

**The Gap Kids shirt** — Jul 9, 2026  
...
> I was, like, so confused and excited. How did this happen? How did this come true?

`memo 2026-07-09_1048_2026-07-09T17_48_09Z`

**The double envelope** — Jul 9, 2026  
...
> It was so strange. It was the second instance of something I had exactly imagined existing in real life the next day.

`memo 2026-07-09_1048_2026-07-09T17_48_09Z`

**The pink satin bed** — Night one, May 2026  
...
`memo 2026-05-27_1958_2026-05-28T02_58_27Z`

**The cat on the wall** — Night two, May 2026  
...
> Whoa, this magic thing is kind of weird. Like, really works.

`memo 2026-05-27_1958_2026-05-28T02_58_27Z`

**The chocolate bars** — Night three, May 2026  
...
> Why hadn't I wished for something bigger?

`memo 2026-05-27_1958_2026-05-28T02_58_27Z`

**The cinnamon cake** — Aug 11, 2026  
...
`memo 2026-08-11_0836_2026-08-11T15_36_26Z`

**The Alive Water truck** — May 7, 2026  
...
> This is really meant for me. Lots of things meant for me.

`memo 2026-05-07_1441_2026-05-07T21_41_41Z`

**The banana clove beer** — Jun 21, 2023  
...
> I always thought that I predicted it, and that's why these things would happen exactly how I thought they would. But it turned out that it wasn't that I was predicting it — it's that I was making it happen.

`memo 2023-06-21_0002_2023-06-21T07_02_25Z`

**Married in six months** — Jun 21, 2023  
I predicted I would get married in six months or whatever. And then I did.

> Basically the ultimate instrumentalism. Like using myself — I'm using myself as an instrument. I don't understand the mechanism.
...
> I became quite undepressed by the end of the evening, all thanks to a pair of gloves that I had no idea why I was buying.

`memo 2026-05-27_1954_2026-05-28T02_54_32Z`

**The dance performance** — May 2026  
...
> Two became three, and after it was over everybody clapped, and no one except my roommates were the wiser.

`memo 2026-05-27_1954_2026-05-28T02_54_32Z`

**The bobby pin and the mushrooms** — May 28, 2026  
...
> I call this strange phenomenon instrumentalism. You follow your heart's desire and it leads you on a path that you didn't know existed.

`memo 2026-05-28_1354_2026-05-28T20_54_21Z`

**The splinter** — Aug 11, 2026  
...
> If that splinter could come out after being lodged in my foot for weeks, then why can't I wake up and suddenly have no other health problems either?

`memo 2026-08-11_0836_2026-08-11T15_36_26Z`

**The boy at the window** — Aug 11, 2026  
...
> Star is the name I have given to magical activities that have already taken place. Spells I have already cast, whose results I already saw.

`memo 2026-08-11_0836_2026-08-11T15_36_26Z`

**The security patrol** — May 17, 2026  
...
> But I was like, wait — maybe I was supposed to take that and go in their car.

`memo 2026-05-16_2200_2026-05-17T05_00_07Z`

**The abandoned cup of water** — May 20, 2026  
...
`memo 2026-05-20_1700_2026-05-21T00_00_00Z`


### SOMETHING STOPPED IT

**The car accident** — May 22, 2026  
...
> The amount of emotion I was feeling was like a prayer to God. Honestly, it felt like I could physically feel my brainwaves. That has never, ever happened to me before or after.

`memo 2026-05-21_1709_2026-05-22T00_09_36Z`

**The scream next door** — May 17, 2026  
...
> So I guess I'm wondering if that's sort of like the car accident thing. Did I cause that, or was it somehow put there for me, to calm us down — or maybe both?

`memo 2026-05-16_2200_2026-05-17T05_00_07Z`

**The homework extensions** — May 22, 2026  
...
> I sort of just got this feeling like I was so lucky all the time. Things just kind of work out in my favor.

`memo 2026-05-21_1709_2026-05-22T00_09_36Z`


### AN ANIMAL SAID IT FOR ME

**The snake on the hike** — May 25, 2026  
...
`memo 2026-05-25_1314_2026-05-25T20_14_45Z`

**The Labrador at the vista** — May 25, 2026  
...
> From that point on, I started noticing how creatures took the shape of what I was thinking or feeling.

`memo 2026-05-25_1314_2026-05-25T20_14_45Z`

**The golden retriever and my dad** — May 25, 2026  
...
**The Yorkie behind the fence** — May 25, 2026  
...
**The cat that wouldn't be petted** — May 25, 2026  
...
**The rat under the table** — May 25, 2026  
...
> He was happy to hear about the dog nuzzling our backs, but did not believe in the snake or the rat.
...
> So I guess it's a sign. But just like, you're doing fine.

`memo 2021-09-29_2209_2021-09-30T05_09_37Z`

**The week of signs** — Aug 11, 2026  
...
> So I got a couple of signs from the universe and now I'm all high in a cloud. No, no, no. You best believe I'm a scientist at heart.

`memo 2026-08-11_0836_2026-08-11T15_36_26Z`

**The pen that came back** — May 17, 2026  
...
> So that's confusing, huh?

`memo 2026-05-16_2200_2026-05-17T05_00_07Z`

**Nicodemus** — May 7, 2026  
...
> I don't know why. I'd say I'm cursed. Something. How to get rid of it? I don't know.

`memo 2026-05-07_1441_2026-05-07T21_41_41Z`

**The Korsakov house** — Jun 21, 2023  
...
> Okay, that's pretty much a coincidence.

`memo 2023-06-21_0013_2023-06-21T07_13_59Z`

**The seeds trivia** — Jul 6, 2022  
...
> That's a really weird coincidence. That's weird, because I also saw that.

`memo 2022-07-06_0108_2022-07-06T08_08_35Z`

**The Archer sex-ed class** — Apr 29, 2024  
...
> Two coincidences that I wanted to record.

`memo 2024-04-29_1010_2024-04-29T17_10_38Z`


### THE ONES YOU KEEP ALMOST TELLING

**The meteorite** — Jan 17, 2026  
...
> I didn't tell anyone else for a while after that, thinking you might still come reclaim your meteorite.

`memo 2026-01-17_1627_2026-01-18T00_27Z`

**The witchcraft business** — Jul 14, 2022  
...
> I call that being ironicized. Like when you do something ironically, and then it kind of becomes real.

`memo 2022-07-14_1152_2022-07-14T18_52_50Z`

**The one you won't tell** — May 26, 2026  
...
> The law of these missions was lack of doubt. No sooner had I to think, I know where this is going, and the whole series of steps would change its course.

`memo 2026-05-25_2030_2026-05-26T03_30_31Z`
...
```
curl -s "https://imageforge-q125.onrender.com/api/search?q=coincidence&kind=memo&limit=40"
curl -s "https://imageforge-q125.onrender.com/api/search?mode=meaning&kind=memo&limit=12&q=<the+shape+of+the+story>"
curl -s "https://imageforge-q125.onrender.com/api/search/transcript/<memo id>"
```

Meaning mode is what finds a story that never says the word — the car accident,
the white gloves and the bobby pin all came back from it and from none of the
keyword passes. The index syncs itself, so a memo she records tomorrow is
searchable without a reindex.

**A new version of the deck is a NEW page**, never an edit of this one
(`POST /api/chatfeed/page` + `POST /page/:id/supersede` on the one it replaces)
— her verdicts are keyed to the sheet name, so rebuilding in place would
re-point them at different cards.
