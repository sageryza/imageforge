...
body={"prompt":open(pfile).read().rstrip('\n'),"model":"seedance-2.5","resolution":"480p","duration":int(os.environ.get("DUR","30")),"generateAudio":True,"aspectRatio":os.environ.get("AR","3:4"),"referenceVideoUrls":json.loads(os.environ.get("REFS","[]")),"referenceImageUrls":json.loads(os.environ.get("IMGS","[]"))}
