...
nothing in the repo knew about, and the ending written this week. This file is
all of them. The research and the fact sheet stay next door in
`research-and-scripts.md`; nothing here invents a fact that is not on that
sheet.

## The order, and the rule behind it

Ordered by **how many recurring faces the spot needs**, fewest first — because
face drift is the measured failure in this project, not the writing. 167 witch
clips are drawn and the cast shelf is empty
(`docs/witch-commercials/cast-audit-2026-09-15.md`): the professor came back as
two different men, the gloomy daughter as two different girls. A spot with no
face in it cannot have that problem, and a spot with an actor in it cannot have
it either. The ones in the middle are where the money goes.

1. **The parts** — hands and a table. No face at all. *(:60, :30 cut)*
2. **Older than the name** — a family in wide shots, no one held in close-up. *(:60, :30 cut)*
3. **Keep the feast** — a family round a table, one read. *(:30, already cut)*
4. **Mothers' night** — three women who must be the same three all the way through. *(:60, :30 cut)*
5. **Patch notes** — footage only, a system voice. *(:60, :30 cut)*
6. **Heritage brand** — hands and objects, an announcer. *(:60, :30 cut)*
7. **Product recall** — objects on white, a voice. *(:60, :30 cut)*
8. **The deposition** — one actor, one room, held on camera throughout. *(:60)*
9. **The witness** — one woman to camera. *(:30)*

Then **THE ENDING**, which rides on the back of 5, 6, 7 or 8.

**Two families, and they do not mix.** 1–4 are sincere: the claim is made
straight and the last image is a fire or a family. 5–9 are comic: a solemn
borrowed form (a software update, a recall notice, a heritage ad, a
deposition) used to say the holiday is made of spare parts. Both are true to
...
## 1. THE PARTS
*Hands only, overhead, a wooden table. Each tradition is set down with its date
on a small card beside it. Straight, museum-quiet. The last thing on the table
is the one with no date.*
*(from the v2 set, 2026-09-05)*

**:00–:08** A sprig of mistletoe set down. A card beside it: 1784.
> VO: "The kiss under the mistletoe. Seventeen eighty-four."

**:08–:16** A tin reindeer. Card: 1823.
> VO: "The eight reindeer, and their names. Eighteen twenty-three."

**:16–:24** A glass bauble. Card: 1848.
> VO: "The tree in the house. Eighteen forty-eight."

**:24–:32** A red felt hat. Card: 1931.
> VO: "The red suit. Nineteen thirty-one."

**:32–:40** A folded letter. Card: 601.
> VO: "Keep the temples. Keep the feasts. Change the name. Six hundred and
> one."

**:40–:50** The hands clear the table. Then set down a single candle and light
it. No card.
> VO: "A fire, at the bottom of the year, and people around it."

**:50–:56** The candle alone.
> VO: "No one wrote the date down. They were already doing it."

**:56–:60** Black.
> SUPER: *Take the dates away. See what is left.*
> SUPER: *Secretly a Witch.*

**:30 cut:** :00–:08 · :16–:24 · :24–:32 · :40–:50 · :56–:60.

**[Extra beats]**
- A small wooden crown. Card: 940. > "A king moves the old feast onto the new
  day, and makes the ale a law. Nine forty."
- A padlock. Card: 1659. > "Banned, for being what it was. Sixteen fifty-nine."
- A horn cup. Card: 725. > "Yule. Written down by a monk who did not approve.
  Seven twenty-five."

---

## 2. OLDER THAN THE NAME
*Slow, quiet, cinematic. The season as it is, then back through the layers to
the oldest one. One voice, unhurried.*
*(from the v2 set, 2026-09-05)*

**:00–:08** A window at dusk, snow, a lit tree inside.
> VO: "Every year, without being asked, we bring a tree into the house."

**:08–:16** A fire being lit. Hands. A table set for too many.
> VO: "We light fires. We gather in the dark. We cook more than we need, and
> we give things away."

**:16–:22** Black. One word of type at a time.
> VO: "We call it Christmas. It has had other names."

**:22–:32** Older footage: a long night, a horn of ale, a fire in a wood.
> VO: "In the north it was Yule. Three nights at the bottom of the year. A
> fire, ale, and one night kept for the mothers."

**:32–:42** A crown. A letter with a seal. A church door.
> VO: "A king moved it onto the twenty-fifth. A pope told his missionaries to
> keep the temples, keep the feasts, and change the name on the door."

**:42–:50** A padlock. Then a Victorian parlour, a red coat on a hook.
> VO: "It was banned for being what it was. Then it was rebuilt, piece by
> piece, and sold back to us."

**:50–:58** Back to the first window. The family inside, the candles.
> VO: "And still, every year, without being asked, we do the oldest thing
> there is. We make light in the dark, and we stay together until it comes
> back."

**:58–:60** Black.
> SUPER: *Christmas is the newest name for the oldest thing we do.*
> SUPER: *Secretly a Witch.*

**:30 cut:** :00–:08 · :16–:22 · :22–:32 · :50–:58 · :58–:60.

**[Extra beats]**
- "The date was chosen by arithmetic. It landed in the darkest week of the
  year, where every people on earth already kept a fire."
- "The reindeer are from a poem. The tree is from a newspaper. The red suit is
  from an advertisement. The fire is from before anyone was writing anything
  down."
- "Nobody knows where the yule log came from. That is how old it is."

---

## 3. KEEP THE FEAST (:30, already cut)
*The pope's letter of 601 read plainly over a modern Christmas table. Nothing
added to it. The words are the spot.*
*(from the v2 set, 2026-09-05)*

**:00–:06** A table being set. Winter light.
> VO: "In the year six hundred and one, a pope wrote to his missionaries."

**:06–:20** The family arriving, coats, the door, the fire.
> VO: "Do not destroy their temples. Sprinkle them with water and set your
> altars inside, so the people will go on coming to the places they know."

**:20–:26** The table full. Plates passed.
> VO: "And since they are used to feasting together, let them keep their
> feasts, in the new name."

**:26–:30** Black.
> SUPER: *They kept the feast. So did we.*
> SUPER: *Secretly a Witch.*

**[Extra beats]**
- "Fourteen hundred years later, the feast is still the part everyone comes
  for."
- A second voice reads the letter in Latin under the English, very low.

---

## 4. MOTHERS' NIGHT
*One documented fact carried by one image. Women, a kitchen, the longest night
of the year. Close and warm. No montage.*
*(from the v2 set, 2026-09-05)*

**:00–:10** A kitchen at night. Three generations of women. Steam, candles,
the window black.
> VO: "The longest night of the year has a name older than Christmas."

**:10–:20** The oldest woman lights a candle. The youngest watches her hands.
> VO: "Thirteen hundred years ago a monk wrote it down. The people of this
> island began their year on the twenty-fifth of December, with a night they
> kept for the mothers."

**:20–:30** The table. Food passed. Nobody hurrying.
> VO: "Mothers' Night. Before the saints, before the carols, before anything
> was sold. A fire, a meal, and the women who kept the year turning."

**:30–:42** The tree in the next room, lit, half out of focus. The women still
at the table.
> VO: "The name changed. The date stayed. The night is still the night."

**:42–:52** The youngest woman blows out the candle. Dark. Then, outside the
window, the first grey of morning.
> VO: "The light comes back because they waited for it."

**:52–:60** Black.
> SUPER: *Mothers' Night. December 24.*
> SUPER: *Secretly a Witch.*

**:30 cut:** :00–:10 · :10–:20 · :42–:52 · :52–:60.

**[Extra beats]**
- "Bede did not approve of it. He wrote it down anyway. That is why we have
  it."
- "Every culture that has ever lived through a winter has a night like this
  one."
- Closing line instead: SUPER: *The oldest night of the year is yours.*
...
## 9. THE WITNESS (short, for the witch account)
...
## THE ENDING — the girl talks

In the comic four, a machine is talking: a system voice, a safety notice, a
...
It rides on the end of **5, 6, 7 or 8** — the comic four. **9 is the grown
woman's spot** and stays as written. The sincere four (1–4) already end on their
own image and do not take it.
