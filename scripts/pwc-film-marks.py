...
MARKS = {
 ...
 "06-emergency-1-eye-contact.png": [
   # Sophie, on v5: "[1:07] circle remain calm, not the face" — the circle
   # goes around the words "STEP 1: Remain calm.", timed to the line, and the
   # approved-smile face is NOT circled (the camera already points at it).
