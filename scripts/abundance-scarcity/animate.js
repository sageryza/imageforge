...
const BEATS = [
  ...
  { id: 'scarcity-1-velvet-throne-v2',
    motion: 'The small glowing bulb on the velvet throne pulses slowly, brighter and then dimmer. The kneeling woman stays still, watching it' },
