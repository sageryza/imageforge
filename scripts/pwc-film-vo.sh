...
# The title line is deliberately bare: no breaks, and no "Official Training
# Film Number One" tail (Sophie, on v6 — "make the very beginning faster get rid
# of official training film, less pauses"). It halved the title card, 6.7s→3.9s.
say "$NARRATOR" 01-title.mp3 'People Watching Club presents: How to Look Without Looking.' 0.7
