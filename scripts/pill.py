...
// one full loop: stopped → tap starts at Medium → each tap steps up
// (Fast, Faster) → tap on Faster pauses → tap starts again. Immediate,
// no double-tap waiting.
window.__scrollTap=function(){
  if(!playing){ si=1; scrollStart(1); return; }
