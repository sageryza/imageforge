...
(async () => {
  ...
  // changed · change back · playground"), and this pass is about the lightbox and its step zones
  ...
  // THE HEART IS ON THE FEED BAR (2026-09-02, Sophie: "actually put the heart
  // x thing exactly where it was" — it rode inside the filters drawer for a
  // day and she put it back).
