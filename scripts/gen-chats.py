...
function renderMsg(m){
  ...
  // Open-in-Claude at the BOTTOM of every message (free — just a link).
  var murl=m.url||openUrl;
  if(murl){ var ob=document.createElement('div'); ob.className='openrow'; ob.appendChild(openClaudeBtn(murl)); row.appendChild(ob); }
  return row;
}
