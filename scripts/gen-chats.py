...
.t-cover .flagbtn{position:absolute; top:5px; left:36px; width:26px; height:26px; z-index:2;}
...
function renderList(el,g,names){
  ...
  names.forEach(function(name){
    ...
    row.appendChild(mkFlag(name,last,row)); row.appendChild(mkCheck(name,last,row));
