...
<div id="beatpop" hidden>
  ...
  <div class="tbox" id="prombox">
    ...
    <div id="drawbox" hidden>
      <div class="bigwrap"><textarea id="dprompt" rows="3" placeholder="what to draw"></textarea><button type="button" class="bigbtn" id="dpromptbig" aria-label="Bigger box"></button></div>
