...
// A dream-team invite link or a personal friend link opens the app on this
// host too (on the dream domain, dream-host.js answers first) — the page
// joins/asks after sign-in.
app.get(['/t/:code', '/f/:code'], (req, res) => { res.set('Cache-Control', 'no-cache, must-revalidate'); res.sendFile(__dirname + '/public/dreamapp.html'); });
