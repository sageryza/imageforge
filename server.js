...
// The dream app — shared dream feed for signed-in friends (membry accounts,
// same users as the witch app / XI). Ungated page; the sign-in lives in it.
app.get('/dreams', (req, res) => { res.set('Cache-Control', 'no-cache, must-revalidate'); res.sendFile(__dirname + '/public/dreamapp.html'); });
